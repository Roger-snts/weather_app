...
abstract class IHTTPController{
  late String url;
  late String apiKey = "5d2c9735ef598d75125d0c5a6766d4e5";
}
...
class WeatherController implements IWeatherController, IHTTPController {
  ...
  @override
  String apiKey = "5d2c9735ef598d75125d0c5a6766d4e5";

  @override
  late String url = "https://api.openweathermap.org/data/2.5/weather?q=$cidade,$estado,$pais&appid=$apiKey";
  
  WeatherController({required this.cliente, required this.cidade, required this.estado, required this.pais});
  ...
  Future<List<WeatherModel>> getWeather() async {
    ...
    if (response.statusCode == 200) {
      ...
      throw StatusNotFoundException(mensagem: "A URL está indisponível no momento.");
    } else {
